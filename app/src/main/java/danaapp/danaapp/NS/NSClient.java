...
import danaapp.danaapp.NS.utils.DateUtil;
...
public class NSClient {
    ...
    private String nsUploadTreatments = SP.getString("ns_sync_upload_treatments", "");
    ...
    public void readPreferences() {
        ...
        nsUploadTreatments = SP.getString("ns_sync_upload_treatments", "");
        ...
        public void call(final Object... args) {
            ...
            try {
                if (nsAcceptCommands) {
                    ...
                    mBus.post(new NSCommandEvent(_id, "bolus", insulin));
                }
            } catch (JSONException e) {
                return;
            }
